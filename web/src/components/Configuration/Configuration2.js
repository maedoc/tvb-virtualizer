...
class Configuration2 extends Component{
    constructor(props){
        super(props);
        this.state = {  
           "openmp.threads": 4,
    ...
    onClickHandler=(event)=>{
        alert("Data Saved for Patient 2")
 ...
 axios.post("http://localhost:8000/input2", data)
.then(res => {
  console.log(res.statusText)
        ...
        return(
            <div className="container">
                ...
                <form className="config_form">
                 <h1>Configuration for Patient 2 </h1>
    ...
    <button type="button" className="save_btn" onClick={this.onClickHandler}>Save Data for Patient 2</button>
   </form>
            </div>
